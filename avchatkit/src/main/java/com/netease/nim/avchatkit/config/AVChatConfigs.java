...
public class AVChatConfigs {
    ...
    private void configFromPreference(SharedPreferences preferences) {
        ...
        videoQuality = Integer.parseInt(preferences.getString(context.getString(R.string.nrtc_setting_vie_quality_key), 5 + ""));
    ...
    private void updateAVChatOptionalConfig() {
        ...
        avChatParameters.setInteger(AVChatParameters.KEY_VIDEO_PREVIEW_QUALITY,videoQuality);
