...
public class AVChatKit {
    ...
    public static void outgoingTeamCall(Context context, boolean receivedCall, String teamId, String roomId, ArrayList<String> accounts, String teamName,
                                        String teamNick, String hearImgUrl,boolean othershow,String shareAccId,boolean isFirstMeet) {
        TeamAVChatActivity.startActivity(context, receivedCall, teamId, roomId, accounts, teamName,teamNick,hearImgUrl,othershow,shareAccId,isFirstMeet);
