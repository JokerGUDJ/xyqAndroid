...
import com.netease.nim.uikit.api.SuperTeamProvider;
...
//    }
    ...
    public static void startContactSelector(Context context, ContactSelectActivity.Option option, ArrayList<String> strings, int requestCode) {
        ContactSelectActivity.startActivityForResult(context, option,strings, requestCode);
    }
