...
public class MessageListPanelHelper {
    ...
    public interface LocalMessageObserver {
        ...
        void onClearMessages(String account, SessionTypeEnum sessionType);
    }
    ...
    public void notifyClearMessages(String account, SessionTypeEnum sessionType) {
        for (LocalMessageObserver o : observers) {
            o.onClearMessages(account, sessionType);
        }
    }
}
