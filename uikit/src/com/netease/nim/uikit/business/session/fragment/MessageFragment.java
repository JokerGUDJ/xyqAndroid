...
import com.netease.nim.uikit.business.session.actions.ImageCarmerAction;
...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //动态权限管理
        RxPermissions subscribe = new RxPermissions(getActivity());
        subscribe.requestEach(Manifest.permission.RECORD_AUDIO)
                .subscribe(new Consumer<Permission>() {
                    ...
                    public void accept(Permission permission) {
                        if (permission.granted) {
                            ...
                            ToastUtils.shortToast(getActivity(), "未获得语音权限，请在设置中允许鑫和家园使用语音！");
                        }
                    }
                });
        return rootView;
    ...
    private void appendPushConfig(IMMessage message) {
        ...
        if (customConfig != null) {
            ...
            if (message.getSessionType().equals(SessionTypeEnum.Team)){
                message.setPushContent("你收到了一条群消息");
            }else{
                message.setPushContent("收到了一条来自"+message.getFromNick()+"的消息");
            }
...
//            }
    ...
    protected List<BaseAction> getActionList() {
        ...
        actions.add(new ImageCarmerAction());//拍照
