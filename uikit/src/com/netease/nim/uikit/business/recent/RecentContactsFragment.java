 ...
 * @Package: com.netease.nim.uikit.business.recent
 * @ClassName: RecentContactsFragment
 * @Description: 会话列表页面
 * @Author: lihy_0203
...
//        emptyHint.setHintTextColor(getResources().getColor(R.color.color_recent_contact));
    }
    ...
    private void initCallBack() {
        ...
        callback = new RecentContactsCallback() {
            ...
            public void onItemClick(RecentContact recent) {
                ...
                //上报埋点
                if(myCallback != null){
                    myCallback.callback(recent.getContactId());
                }
            }
