...
/**
 * @author lihy_0203
 * @class TopicDetailAdatper
 * @Createtime 2019/6/20 15:36
 * @description 话题详情适配器
 * @Revisetime
 * @Modifier
 */

public class TopicDetailAdatper extends BaseRecycleViewAdapter {
    ...
    public TopicDetailAdatper(Context context, List<PostListBean.ContentBean> list, onItemCommonClickListener commonClickListener) {
