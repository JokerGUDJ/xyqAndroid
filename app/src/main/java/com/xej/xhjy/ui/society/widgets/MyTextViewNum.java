...
public class MyTextViewNum extends View {
    ...
    public MyTextViewNum(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyTextViewNum(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
