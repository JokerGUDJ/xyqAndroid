...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.name_selector_color;
    /**
     * 整个textView的背景色
     */
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = ClubApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = ClubApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
