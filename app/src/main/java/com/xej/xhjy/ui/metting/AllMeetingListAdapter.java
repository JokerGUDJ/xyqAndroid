...
public class AllMeetingListAdapter extends RecyclerView.Adapter<AllMeetingListAdapter.MyViewHolder> {
    ...
    public AllMeetingListAdapter(Context context, List<XHMeeting> meetList) {
        super();
    ...
    @NonNull
    @Override
    public AllMeetingListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // TODO 自动生成的方法存根
        ...
        AllMeetingListAdapter.MyViewHolder holder = new AllMeetingListAdapter.MyViewHolder(view);
        return holder;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull AllMeetingListAdapter.MyViewHolder holder, int position) {
        XHMeeting meeting = meetList.get(position);
        try{
            if(meeting != null){
                ...
                if("M".equals(meeting.getMeetFrom())){
                    holder.tv_meet_addr.setText("会场地点："+meeting.getAddress());
                    setMeetStatus(holder.img_meet_label, meeting.getStt());
                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if(view.getScrollX() > 0){
                                ...
                                Intent intent = new Intent();
                                intent.putExtra(MEETING_ID, meeting.getId());
                                intent.putExtra(OnlineMeetingDetailActivity.WHETHER_JOIN, meeting.getWhetherJoin());
                                ...
                                EventTrackingUtil.EventTrackSubmit((BaseActivity)context, "pageHome", "channel=android",
                                        "eventViewMeet", "meetId="+meeting.getId());
                                context.startActivity(intent);
                            }
//                            if(holder.itemView.getScrollX() == 0){
//                                Intent intent = new Intent();
