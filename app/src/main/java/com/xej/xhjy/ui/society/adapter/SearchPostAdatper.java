...
/**
 * @author lihy_0203
 * @class SearchPostAdatper
 * @Createtime 2019/6/26 15:36
 * @description 帖子搜索列表SearchPostAdatper
 * @Revisetime
 * @Modifier
 */

public class SearchPostAdatper extends BaseRecycleViewAdapter {
    ...
    public SearchPostAdatper(Context context, List<PostListBean.ContentBean> list, onItemCommonClickListener commonClickListener) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        holder = (CircleViewHolder) viewHolder;
        ...
        String userId = PerferenceUtils.get(AppConstants.User.ID, "");
