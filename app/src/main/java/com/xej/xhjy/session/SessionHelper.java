...
import com.xej.xhjy.session.action.AVChatAction;
import com.xej.xhjy.session.action.TeamAVChatAction;
import com.xej.xhjy.session.extension.CustomAttachParser;
import com.xej.xhjy.session.extension.CustomAttachment;
import com.xej.xhjy.session.extension.GuessAttachment;
import com.xej.xhjy.session.extension.RedPacketAttachment;
import com.xej.xhjy.session.extension.RedPacketOpenedAttachment;
import com.xej.xhjy.session.extension.StickerAttachment;
import com.xej.xhjy.session.viewholder.MsgViewHolderDefCustom;
import com.xej.xhjy.session.viewholder.MsgViewHolderGuess;
import com.xej.xhjy.session.viewholder.MsgViewHolderNertcCall;
...
public class SessionHelper {
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor) {
        if (!IMCache.getAccount().equals(account)) {
