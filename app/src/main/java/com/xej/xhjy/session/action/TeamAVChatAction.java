package com.xej.xhjy.session.action;
...
import com.xej.xhjy.ui.metting.OnlineMeetingOrderActivity;
...
public class TeamAVChatAction extends AVChatAction {
    ...
    public void startAudioVideoCall(ChannelType avChatType) {
        ...
        intent.setClass(getActivity(), OnlineMeetingOrderActivity.class);
...
//                    } else {
//                        NimUIKit.startContactSelector(getActivity(), getContactSelectOption(tid),new ArrayList<>(), TeamRequestCode.REQUEST_TEAM_VIDEO);
//                    }
//                }
//            }
//        });
