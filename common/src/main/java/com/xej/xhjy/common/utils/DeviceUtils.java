...
public class DeviceUtils {
	...
	public static String getIMEI(Context context) {
		@SuppressLint("WrongConstant") TelephonyManager tm = (TelephonyManager) context
	...
	public static Map<String, String> getAPKMD5Info(Context context) {
		...
		try {
			...
			for (Signature signature : packageInfo.signatures) {
				// 取到Package的签名
				SIGNATURE_FLAG = MD5Utils
						.getMD5String(signature.toCharsString());
			}
			// 取到APKMD5
			APKMD5_FLAG = MD5Utils.getFileMD5String(f);
